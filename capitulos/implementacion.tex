...
\begin{prop}
    ...
    %\textit{In Android 6, revoking a permission does not invalidate the right of performing an operation over resources protected by it that the application may have delegated.}
\end{prop}