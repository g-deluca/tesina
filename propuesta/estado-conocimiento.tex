...
pre-instaladas con el sistema operativo} o creada por algún desarrollador, puede,
con los permisos adecuados, utilizar tanto los recursos/servicios del
...
qué es lo que se espera del sistema sin ambigüedades y tener, no solo la capacidad
de probar que ciertas propiedades de seguridad son correctas, sino también una prueba
tangible y computable de las mismas. Contar con un modelo formalmente especificado
de los mecanismos de seguridad de esta plataforma permite formular precisamente las propiedades
que la misma debe garantizar, validar su satisfacción, razonar sobre el comportamiento esperado de
la misma y eventualmente derivar o inferir la necesidad de mecanismos y/o propiedades
...
grado~\cite{aromano, fgorostiaga} dirigidos por un miembro del actual equipo,
